Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = "https://github.com/heitortsergent/sendgrid-objc"
  s.license          = { :type => 'MIT', 
                         :file => "MIT.LICENSE"}
  s.authors          = { "Kunal Batra" => "kunal.batra@sendgrid.com",
                         "Heitor Tashiro Sergent" => "heitortsergent@gmail.com" }
  s.source           = { :git => "https://github.com/heitortsergent/sendgrid-objc.git", :tag => s.version.to_s }
  s.social_media_url = 'https://twitter.com/sendgrid'

  s.deprecated_in_favor_of = 'SendGrid'
